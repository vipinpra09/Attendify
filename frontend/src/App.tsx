      ...
      <AuthProvider>
        <HashRouter>
          <Routes>
            ...
            <Route path="/admin/timetable" element={<RequireRole role="ADMIN"><TimeTablePage /></RequireRole>} />
            <Route path="/admin/notices" element={<RequireRole role="ADMIN"><NoticesPage /></RequireRole>} />
            ...
            <Route path="/teacher/timetable" element={<RequireRole role="TEACHER"><TimeTablePage /></RequireRole>} />
            <Route path="/teacher/notices" element={<RequireRole role="TEACHER"><NoticesPage /></RequireRole>} />
            ...
            <Route path="/student/timetable" element={<RequireRole role="STUDENT"><TimeTablePage /></RequireRole>} />
            <Route path="/student/history" element={<RequireRole role="STUDENT"><HistoryPage /></RequireRole>} />
            <Route path="/student/notices" element={<RequireRole role="STUDENT"><NoticesPage /></RequireRole>} />
